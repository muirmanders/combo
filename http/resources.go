...
func comboJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "combo.js", size: 6327, mode: os.FileMode(420), modTime: time.Unix(1435200468, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
